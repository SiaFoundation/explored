...
CREATE TABLE host_info (
    ...
    -- settings
    accepting_contracts INTEGER NOT NULL,
    max_download_batch_size BLOB NOT NULL,
    max_duration BLOB NOT NULL,
    max_revise_batch_size BLOB NOT NULL,
    net_address TEXT NOT NULL,
    remaining_storage BLOB NOT NULL,
    sector_size BLOB NOT NULL,
    total_storage BLOB NOT NULL,
    address BLOB NOT NULL,
    window_size BLOB NOT NULL,
    collateral BLOB NOT NULL,
    max_collateral BLOB NOT NULL,
    base_rpc_price BLOB NOT NULL,
    contract_price BLOB NOT NULL,
    download_bandwidth_price BLOB NOT NULL,
    sector_access_price BLOB NOT NULL,
    storage_price BLOB NOT NULL,
    upload_bandwidth_price BLOB NOT NULL,
    ephemeral_account_expiry INTEGER NOT NULL,
    max_ephemeral_account_balance BLOB NOT NULL,
    revision_number BLOB NOT NULL,
    version TEXT NOT NULL,
    release TEXT NOT NULL,
    sia_mux_port TEXT NOT NULL
);
