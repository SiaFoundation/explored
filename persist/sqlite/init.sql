...
CREATE TABLE host_info (
    ...
    settings_accepting_contracts INTEGER,
    settings_max_download_batch_size BLOB,
    settings_max_duration BLOB,
    settings_max_revise_batch_size BLOB,
    settings_net_address TEXT,
    settings_remaining_storage BLOB,
    settings_sector_size BLOB,
    settings_total_storage BLOB,
    settings_address BLOB,
    settings_window_size BLOB,
    settings_collateral BLOB,
    settings_max_collateral BLOB,
    settings_base_rpc_price BLOB,
    settings_contract_price BLOB,
    settings_download_bandwidth_price BLOB,
    settings_sector_access_price BLOB,
    settings_storage_price BLOB,
    settings_upload_bandwidth_price BLOB,
    settings_ephemeral_account_expiry INTEGER,
    settings_max_ephemeral_account_balance BLOB,
    settings_revision_number BLOB,
    settings_version TEXT,
    settings_release TEXT,
    settings_sia_mux_port TEXT
    -- price table
    price_table_uid BLOB,
    price_table_validity INTEGER,
    price_table_host_block_height BLOB,
    price_table_update_price_table_cost BLOB,
    price_table_account_balance_cost BLOB,
    price_table_fund_account_cost BLOB,
    price_table_latest_revision_cost BLOB,
    price_table_subscription_memory_cost BLOB,
    price_table_subscription_notification_cost BLOB,
    price_table_init_base_cost BLOB,
    price_table_memory_time_cost BLOB,
    price_table_download_bandwidth_cost BLOB,
    price_table_upload_bandwidth_cost BLOB,
    price_table_drop_sectors_base_cost BLOB,
    price_table_drop_sectors_unit_cost BLOB,
    price_table_has_sector_base_cost BLOB,
    price_table_read_base_cost BLOB,
    price_table_read_length_cost BLOB,
    price_table_renew_contract_cost BLOB,
    price_table_revision_base_cost BLOB,
    price_table_swap_sector_base_cost BLOB,
    price_table_write_base_cost BLOB ,
    price_table_write_length_cost BLOB,
    price_table_write_store_cost BLOB,
    price_table_txn_fee_min_recommended BLOB,
    price_table_txn_fee_max_recommended BLOB,
    price_table_contract_price BLOB,
    price_table_collateral_cost BLOB,
    price_table_max_collateral BLOB,
    price_table_max_duration BLOB,
    price_table_window_size BLOB,
    price_table_registry_entries_left BLOB,
    price_table_registry_entries_total BLOB
);
